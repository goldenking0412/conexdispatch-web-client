...
class EventDeletionModal extends React.Component {
    ...
    delete_event() {
        ...
        this.props.dispatch(async_delete_event(event_id)).catch(fetch_error);
    }
        ...
        return (
            ...
            >
                ...
                <div className="button-group text-center callout">
                    <a className="alert button expanded" onClick={this.delete_event}>
                        Delete event
                    </a>
                    <a className="secondary button expanded" onClick={this.close_modal}>
                        Cancel
                    </a>
                </div>
            </div>
